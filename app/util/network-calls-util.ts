...
export interface AppXHRParams {
    ...
    APPSESSIONID?: string;
    secure?: boolean;
    requestHeaders?: Array<AppXHRRequestHeader>;
    payload?: object
}
 ...
 * sd _ Kaybarax
 */
export interface AppXHRRequestHeader {
    key: string;
    value: string;
}
 ...
 */
export function appXHR(params: AppXHRParams) {
 ...
 */
export function xhrPromise(params: AppXHRParams) {
